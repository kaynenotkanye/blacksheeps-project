...
This is a hard-fork from stefanprodan's dockprom project with some additional modifications.
This is a temporary group project where we are playing around with sidecar monitoring.
...
Clone this repository on your Docker host, cd into SidecarMon directory and run the startup.sh script:

After the containers have started up, you should be able to log into Grafana by opening up your browser and navigating to http://localhost:3000 (By default, we are using admin/admin to log in.)
